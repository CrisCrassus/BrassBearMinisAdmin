<div class="bg-primary py-12">
    <div class="w-3/5 mx-auto text-white font-ibarra">
        ...
        <div class="w-full flex justify-between border-b border-white border-solid items-center">
            ...
            <div class="flex gap-x-5">
                <a href="" class="text-lg text-white/70 hover:text-white transition-colors duration-150">On Sale</a>
                <a href="" class="text-lg text-white/70 hover:text-white transition-colors duration-150">View Ranges</a>
                <a href="" class="text-lg text-white/70 hover:text-white transition-colors duration-150">3D Printing</a>
                <a href="" class="text-lg text-white/70 hover:text-white transition-colors duration-150">Contact</a>
            </div>
        </div>
